...
public class ProjectLayout extends GridLayout {
	...
	private void constructLayout() {
		...
		Label project_name = new Label("<div style=\"background-color:lime\"><strong>" + this.project.getId().trim() + "</strong></div>",Label.CONTENT_XHTML);//("<strong bgcolor=\"lime\">" + this.project.getId() + "</strong>",Label.CONTENT_XHTML);
